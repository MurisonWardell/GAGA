...
gagaReport(gaga_synthetic_data,x,outType="fitness")
gagaReport(gaga_synthetic_data,x,outType="heatmap")
gagaReport(gaga_synthetic_data,x,outType="proportion")
gagaReport(gaga_synthetic_data,x,outType="phylogeny")
